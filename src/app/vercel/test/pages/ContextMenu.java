...
public class ContextMenu extends VercelTestBase {
    ...
    public void testText(){
        ...
        Assert.assertEquals(header.getText(), CONTEXT_MENU_HEADER, "Contextmenu paragraph text " + VercelTestBase.MESSAGE_MATCH);
        ...
        for (int i = 0; i < paragraphs.size(); i++) {
            ...
            Assert.assertEquals(sentence.getText(), CONTEXT_MENU_PARAGRAPHS[i], "paragraph text " + i + VercelTestBase.MESSAGE_MATCH);
        }
    }
